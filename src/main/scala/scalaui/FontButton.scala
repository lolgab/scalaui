...
// import scala.scalanative.unsafe.{CFuncPtr0, CFuncPtr2, Ptr, stdlib, sizeof}

// class FontButton private (changeFont: CFuncPtr2[Ptr[uiFontButton], Ptr[Byte], Unit],
...
//     uiFontButtonOnChanged(control, changeFont, onFontChange.asInstanceOf[Ptr[Byte]])
//   }
